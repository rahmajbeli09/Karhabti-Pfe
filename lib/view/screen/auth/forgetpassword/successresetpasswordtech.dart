...
class SuccessResetPasswordTech extends StatelessWidget {
   SuccessResetPasswordTech({Key? key}) : super(key: key);
        ...
        child: Column(
         mainAxisAlignment: MainAxisAlignment.center,
               children: [
                 ...
                 SizedBox(height: 50,),
                 Boutton(text: "Suivant", onPressed: (){controller.goToHomeTech();} , color: Colors.amber,)
               ],
             ),
      ),
    );
